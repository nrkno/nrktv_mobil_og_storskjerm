...
#+begin_src bigquery
  #standardSQL
SELECT platform,TIME(timeFrame, 'Europe/Oslo'), TIME(EXTRACT(HOUR FROM TIME(timeFrame, 'Europe/Oslo')), CAST(20 * FLOOR(EXTRACT(MINUTE FROM TIME(timeFrame, 'Europe/Oslo')) / 20) AS INT64), 0), HLL_COUNT.MERGE(visitorsSketch) klienter
